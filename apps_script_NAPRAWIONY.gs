...
function logowanie(dane) {
  ...
  // UWAGA (poprawka 3.20.53): NIE odrzucamy tu zgloszenia po dlugosci "telefonu".
  // Program wysyla haslo rowniez w polu "telefon" (zaszlosc z czasow logowania
  // numerem), wiec haslo literowe mialo tu 0 cyfr i logowanie bylo odbijane
  // ZANIM ktokolwiek sprawdzil haslo. Numer weryfikujemy nizej — tylko w
  // galezi telefonicznej, czyli gdy konto nie ma jeszcze ustawionego hasla.
