...
cd /d "%~dp0"
echo ============================================
echo  PMT Planer - budowa exe od zera (3.20.3)
echo ============================================
echo.
...
findstr /C:"WERSJA_PROGRAMU = \"3.20.3\"" PMT_Delegacje.py >nul
if errorlevel 1 (
  echo [BLAD] PMT_Delegacje.py w tym folderze to NIE wersja 3.20.3.
  echo        Podmien plik na ten z paczki i uruchom ponownie.
  pause & exit /b 1
)
echo [OK] Zrodlo: PMT_Delegacje.py w wersji 3.20.3
...
>"dist\PMT_Planer\pmt_wersja.txt" echo 3.20.3
